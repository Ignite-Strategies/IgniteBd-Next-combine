...
// Placeholder component - redirects to contacts ingest
// Microsoft OAuth is purpose-specific: importing contacts from email
// It should only be initiated from /contacts/ingest/microsoft
import { useRouter } from 'next/navigation';
