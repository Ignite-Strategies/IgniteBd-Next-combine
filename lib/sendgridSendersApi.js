...
/**
 * @deprecated DO NOT USE - SendGrid doesn't allow API-based sender creation/verification
 * Creating/verifying senders must be done manually in SendGrid dashboard
 * 
...
export async function createVerifiedSender(senderData) {
  throw new Error(
    'Sender verification cannot be automated via API. ' +
    'Please add and verify senders in the SendGrid dashboard, then refresh the list here.'
  );
}
