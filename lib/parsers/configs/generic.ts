...
Your job is to analyze unstructured text and extract factual information into a strict JSON object.
...
Return ONLY JSON. No markdown, no explanations, no commentary.`,
  ...
  buildUserPrompt: (raw: string, context: string | null) => `Extract structured data from the following raw text.
