...
export interface VariableResolutionContext {
  // Contact identifier (one of these required for CONTACT variables)
  contactId?: string;
  contactEmail?: string;
  
  // Owner identifier (for owner/system variables)
  ownerId?: string;
  
  // Additional metadata for computed values
 ...
 */
export type VariableSource = 'CONTACT' | 'OWNER' | 'COMPUTED';
...
export interface VariableDefinition {
  ...
  description?: string;
  dbField?: string; // Database field path (e.g., "firstName", "companyName")
  computed?: boolean; // If true, value is computed rather than from DB
}
