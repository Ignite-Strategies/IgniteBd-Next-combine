...
export default function PresentationsFromExistingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <PageHeader
          title="Use Previous Presentation"
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-lg">
          ...
          <p className="text-gray-600 mb-8">
            Start from an existing presentation as a template. This feature is currently in development.
          </p>
          <button
            onClick={() => router.back()}
