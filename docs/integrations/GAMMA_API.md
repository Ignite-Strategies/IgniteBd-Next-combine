...
```json
{
  "id": "gamma-generated-id",
  "url": "https://gamma.app/deck/{id}"
}
```

- `id`: The gammaId generated by Gamma
- `url`: Shareable deck URL
...
3. **API Call**: `generateDeckWithGamma()` sends POST request to Gamma API
4. **Store URL**: Response URL stored in `Presentation.gammaDeckUrl`
